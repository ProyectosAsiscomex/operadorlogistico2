...
[Table("causacionesencabezadoanticipo")]
public partial class causacionesencabezadoanticipo
{
    [Key]
    public int idcausacionxanticipo { get; set; }
    ...
    public int? idCausacionAnterior { get; set; }
